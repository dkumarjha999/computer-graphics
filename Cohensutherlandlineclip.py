...
# region code based on TBRL values 
...
def multiline_clip():
	while True:
		...
		if num==0:
			...
			pass
def inputwindow_values():
	global xw_min,xw_max,yw_min,yw_max
	xw_min=input("Enter window xw_min coordinate : ")
	yw_min=input("Enter window yw_min coordinate : ")
	xw_max=input("Enter window xw_max coordinate : ")
	yw_max=input("Enter window yw_max coordinate : ")
